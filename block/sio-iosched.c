...
/* Tunables */
static const int sync_read_expire  = 150;	/* max time before a sync read is submitted. */
static const int sync_write_expire = 500;	/* max time before a sync write is submitted. */

static const int async_read_expire  =  1000;	/* ditto for async, these limits are SOFT! */
static const int async_write_expire = 4000;	/* ditto for async, these limits are SOFT! */
